...
def parse_args():
    ...
    parser.add_argument('--st_model', type=str, default='ONet',
                        help='NUDT-SIRST_DNANet_31_07_2021_14_50_57_wDS,'
                             'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS')
    parser.add_argument('--model_dir', type=str,
                        default = 'APCMwitonlocal/mIoU__ONet_NUAA-SIRST_epoch.pth.tar',
                        help    = 'NUDT-SIRST_DNANet_31_07_2021_14_50_57_wDS/mIoU__ONet_NUDT-SIRST_epoch.pth.tar,'
                                  'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS/mIoU__ONet_NUAA-SIRST_epoch.pth.tar')
